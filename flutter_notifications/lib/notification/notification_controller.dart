  ...
  void display(RemoteMessage message)async{
    ...
    try{
      ...
      final NotificationDetails notificationDetails = NotificationDetails(
        android:  AndroidNotificationDetails('vietravel_channel', 'vietravel_channel', 'vietravel_channel',
  ...
  gotoDetailScreen(DataNotifyModel dataModel){
    switch (dataModel.type_id) {
      ...
      print('gotoDetailScreen ${dataModel}');
        //Navigator.push(context,MaterialPageRoute(builder: (context) => PromotionDetailsScreen(model: PromotionModel.fromNotification(dataModel),)));
        break;
      case '2':// new
        print('gotoDetailScreen ${dataModel}');
