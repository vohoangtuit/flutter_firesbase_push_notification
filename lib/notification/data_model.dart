...
class DataNotifyModel{
  ...
  String? object_id;
  String? click_action;
  DataNotifyModel({this.type_id, this.message,this.title,this.notification_id,this.content,this.object_id,this.click_action});
  ...
  factory DataNotifyModel.fromJsonAndroid(Map<String,dynamic> json) =>DataNotifyModel(
      ...
      content:json[NOTIFY_DATA]['content'],
...
@override
  String toString() {// todo handle  pyload
    return '{"type_id": "$type_id", "message": "$message", "title": "$title","content": "$content", "notification_id": "$notification_id", "object_id": "$object_id", "click_action": "$click_action"}';
  }
}